 ...
 **/
@EViewGroup(R.layout.adapter_business_demend)
public class BusinessDemindViewHold extends LinearLayout {
    ...
    public BusinessDemindViewHold(Context context) {
        super(context);
        mContext = context;
    }

    public BusinessDemindViewHold(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public void bind(final MydemandModel model){
