...
public class CitySortAdapter extends BaseAdapter implements SectionIndexer{
	private List<ProvenceModel> list = null;
	private Context mContext;

	public CitySortAdapter(Context mContext, List<ProvenceModel> list) {
		this.mContext = mContext;
		this.list = list;
	}
	

	public void updateListView(List<ProvenceModel> list){
		this.list = list;
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		final ProvenceModel mContent = list.get(position);
		if (view == null) {
