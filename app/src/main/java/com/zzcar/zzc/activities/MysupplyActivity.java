...
public class MysupplyActivity extends BaseActivity {
    ...
    private void initTab() {
        ...
        MysupplyActivity.TabInfo homeTabInfo = new MysupplyActivity.TabInfo(fragment_zaishou, "进行中");
        infos.add(homeTabInfo);

        MysupplyActivity.TabInfo preheatTabInfo = new MysupplyActivity.TabInfo(fragment_yishou, "已到期");
    ...
    private class TabFragmentAdapter extends FragmentPagerAdapter implements IconPagerAdapter {
        ...
        private ArrayList<MysupplyActivity.TabInfo> tabInfos;

        public TabFragmentAdapter(ArrayList<MysupplyActivity.TabInfo> tabInfos) {
