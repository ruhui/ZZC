 ...
 * 描述：
 * 创建作者： 黄如辉
 * 创建时间： 2017/6/17 17:53
 **/
public class SavedemandResponse {
    ...
    public PropsName props_name;

    public SavedemandResponse() {}

    public SavedemandResponse(String info_id, String bland_id, String series_id, int on_number_min_year, int on_number_max_year,
                             double min_price, double max_price, List<String> color, List<String> inside_color, String content, PropsName props_name) {
    ...
    public PropsName getProps_name() {
        return props_name;
    }

    public void setProps_name(PropsName props_name) {
        this.props_name = props_name;
    }
