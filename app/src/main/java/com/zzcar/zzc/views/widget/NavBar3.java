...
@EViewGroup(R.layout.view_nav_bar3)
public class NavBar3 extends Toolbar {
    ...
    public NavBar3(Context context) {
        super(context);
    }

    public NavBar3(Context context, AttributeSet attrs) {
        super(context, attrs);
