...
//        messageList.setAvatarShape(1);
    ...
    protected void sendMessage(EMMessage message){
        ...
        sendMessageListener.setOnSendMessageListener(message);
        //send message
    ...
    protected void selectPicFromCamera() {
        ...
        startActivityForResult(
                new Intent(MediaStore.ACTION_IMAGE_CAPTURE).putExtra(MediaStore.EXTRA_OUTPUT, mOriginUri),
                REQUEST_CODE_CAMERA);
    }
    ...
    public void setSendMessageHelper(SendMessageListener sendMessageListener){
